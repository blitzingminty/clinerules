...
2. Check the mistakes-registry.md to avoid repeating known issues
3. Review the anti-patterns.md for approaches to avoid
4. Consult the learnings.md for applicable knowledge
5. Reference the decisions-log.md for precedent and consistency
